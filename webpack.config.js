...
//var cssExtract = new ExtractTextPlugin('style.css');
...
module.exports = {
    ...
    /* 打包后要输出的文件在此配置 */
    output: {
        publicPath: '/build/', // 这是在启动webpack-dev-server时，bundle.js的引用路径应该相对于此路径，即在index.html中：
    ...
    /* 配置一些额外的webpack插件 */
    plugins: [
        new OpenBrowserPlugin({ url: 'http://127.0.0.1:8081' })
    ],
    /* 配置额外的自定义方案 */
    resolve: {
